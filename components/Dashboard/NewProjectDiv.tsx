...
const NewProjectDiv : React.FC<NewProjectProps> = ({ id, toggleProjectDetails }) => {
      ...
      <div className='mt-5 flex justify-between'>
        <div className='flex'>
          <div className='lg:flex gap-1 hidden'>
            ...
            <div className='flex'><p className='text-[0.8rem] cursor-pointer'>+<span className='hover:underline' onClick={() => toggleProjectDetails(id)}>45 more</span></p></div>
          </div>
        </div>
        <div className='flex'>
